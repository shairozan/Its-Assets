...
function asset_admin($key, $insert) {
        ...
        if ($complete != "1") {        
                ...
                echo "<tr><td align='right' valign='top'><font class='text11bold'>End of Life: <font class='text12'></font></font></td><td><input type='date' size=7 name='exp_date' class='boxtext13' value=\"" . $exp_date . "\"><br><i><left>Please note that End of Life Dates are to be in YYYY-MM-DD Format</left></i></td></tr>\n";
